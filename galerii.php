...
switch($domain)
{
case 'exp': $imgdir="../pildid/Image/Tootuba/".$line["galerii"]."/thumbs/"; $imgdir_o="../pildid/Image/Tootuba/".$line["galerii"]."/"; $imgdir_s="../pildid/Image/Tootuba/".$line["galerii"]."/thumbs_s/"; $misasjale="töötoale"; break;
...
?>         <tr> 
     ...
     <tr>
        <td width="4%" rowspan="7" valign="top" class="menu">
          <a href="<? echo $imgdir_o,$line_pilt["fail"]; ?>"><img src="<? echo $line_pilt["url_kataloog"],$line_pilt["fail"]; ?>" border="0" bord="0"></a>          </td>
