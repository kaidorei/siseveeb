<?
    ...
    $link = mysql_connect("localhost", "fyysika", "sSEaDBwMtgUP")
...
//	mb_internal_encoding('UTF-8');
    ...
    mysql_select_db("fyysika_nina") or die("Could not select database"); 
...
<?
	...
	$query="SELECT * FROM mdl_course WHERE id>28";
...
switch($line["id"]) {
	...
	case 29:
		...
		$range_g=" itemid>204 AND itemid<212";//fg
	...
	case 30:
		...
		$range_g=" itemid>213 AND itemid<221"; //fpk
	...
	case 31:
		...
		$range_g=" itemid>222 AND itemid<230"; //b
	...
	case 32:
		...
		$range_g=" itemid>231 AND itemid<239";// k
...
// lisa uus tegelane tõendite andmebaasi
		...
		$query_t="INSERT INTO `fyysika_nina`.`mdl_user_toendid_16` (`id`, `username`, `firstname`, `lastname`, `email`, `skype`, `phone1`, `phone2`, `institution`, `department`, `address`, `city`, `country`, `course`, `group`, `count`) VALUES (NULL, 'usern', '".$line_u["firstname"]."', '".$line_u["lastname"]."', '".$line_u["email"]."', '', '', '', '".$line_k["data"]."', '', '', '', 'EE', '".$line["fullname"]."', '".$line_ryhmad["name"]."', '".$line_o[0]."')";
