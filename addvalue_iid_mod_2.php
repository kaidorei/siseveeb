<?
	  ...
	  $order2=$_GET["order2"];	
	  $dom=$_GET["domain"];
	  if(!$dom) $dom="raamat6_exp";	
	  $sel=$_GET["sel"];
	  if(!$sel) $sel=1;	
	  $naita_veebis=$_GET["naita_veebis"];
	  $teekoopia=$_GET["teekoopia"];
	  $isotroopne=$_GET["isotroopne"];
	  $tehtud=0;	
		if($_GET["act"]=="upi"){	
			echo "uuendan ... ";
			$var=$_POST;
		...
		if($_POST["teekoopia"])
		{
			$query_insert="INSERT INTO ".$dom." (oid1,oid2,title1,sisse1,sisu1) VALUES (\"".$oid."\",\"".$_POST["entity"]."\",\"".$title."\",\"".$sisse."\",\"".$sisu."\")";
		...
		if(!$_POST["isotroopne"])
		{
				switch($sel)
				{
					...
					$query="UPDATE ".$dom." SET oid1='".$_POST["oid1"]."', oid2='".$_POST["oid2"]."', order1='".$_POST["order1"]."', order2='".$_POST["order2"]."', title1='".$_POST["seos_title"]."', sisse1='".$_POST["seos_sisse"]."', sisu1='".$_POST["seos_sisu"]."', naita_veebis1='".$_POST["naita_veebis"]."' WHERE id=".$id;
					break;
		...
		{			
		$query="UPDATE ".$dom." SET oid1='".$_POST["oid1"]."', oid2='".$_POST["oid2"]."', order1='".$_POST["order1"]."', order2='".$_POST["order2"]."', title1='".$_POST["seos_title"]."', sisse1='".$_POST["seos_sisse"]."',sisse2='".$_POST["seos_sisse"]."', sisu1='".$_POST["seos_sisu"]."', sisu2='".$_POST["seos_sisu"]."', naita_veebis1='".$_POST["naita_veebis"]."', naita_veebis2='".$_POST["naita_veebis"]."' WHERE id=".$id;
		}
...
<? if($tehtud!=1) {?><table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr> 
    <td width="71" background="image/sinine.gif" class="menu" >V&auml;li <? echo $sel;?></td>
    <td background="image/sinine.gif" class="menu"><span class="options">
      <? 
//	echo $dom;
	switch($sel)
	{
		case '1': 	echo $line1[$asi1];
		break;
		case '2': echo $line2[$asi2];
		break;
	}
	 ?>
    </span></td>
...
//	echo $dom;
	switch($sel)
	{
		case '1': echo $line2[$asi2];
		break;
		case '2': echo $line1[$asi1];
		break;
	}
	 ?>
    </span></td>
...
<tr background="image/sinine.gif"> 
    <td colspan="4" background="image/sinine.gif"><img src="image/sinine.gif" width="1" height="1"></td>
     ...
     <td colspan="1" valign="top" class="options" >&nbsp;</td>
     <td class="options" >order1: 
       <input name="order1" type="text"  class="menu_punane" value="<? echo $line["order1"]; ?>" size="5" >
&lt;-&gt;</td>
     <td class="options" >order2
...
<tr> 
    <td colspan="1" class="options" >&nbsp;</td>
    <td width="613" colspan="1" valign="middle" class="options" ><?
...
?></select></td><td width="615" align="left" valign="middle" class="options" ><select class="options" name="oid2">
            <? 
...
?>
    ...
    <td width="103" align="center" class="options" >
      <strong>N&auml;ita veebis: </strong>
...
<tr background="image/sinine.gif"> 
    ...
    <tr>
     ...
     <td class="options" ><textarea cols="60" rows="1" class="fields" name="seos_title" type="text" value="" ><? echo $title;?> </textarea></td>
     <td class="options" ><textarea cols="60" rows="1" class="fields" name="textarea" type="text" value="" ><? echo $title;?> </textarea></td>
     <td class="options" ><label>
       <input type="checkbox" name="teekoopia" value="teekoopia">
       <strong>Tee koopia </strong></label></td>
    </tr>
<tr background="image/sinine.gif"> 
    <td colspan="4" background="image/sinine.gif"><img src="image/sinine.gif" width="1" height="1"></td>
  </tr>
...
$oFCKeditor->Create() ;
	?></td>
     <td valign="top" class="options" >&nbsp;</td>
     <td valign="top" class="options" ><label>
       <input type="checkbox" name="isotroopne" value="isotroopne">
       <strong>Isotroopseks<br>
(siit sinna)</strong></label></td>
   </tr>
<tr background="image/sinine.gif"> 
    <td colspan="4" background="image/sinine.gif"><img src="image/sinine.gif" width="1" height="1"></td>
  </tr>
