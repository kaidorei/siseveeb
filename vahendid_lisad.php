...
<tr> 
    <td background="image/sinine.gif" class="menu"><img src="image/spacer.gif" width="10" height="10">Märkused, kommentaarid, arendus </td>
</tr>
<tr> 
    <td>
     	 <?
		...
		$tmp=array("date","body");
		log2("vahendid_alog",(isset($_GET["isik_alogopen"])?0:2),$vid,$_SESSION["mysession"]["login"],implode(",",$tmp));
		?>
    </td>
</tr>
</table>
