<?
	  ...
	  $tehtud=0;	
		...
		$var=$_POST;
				...
				$query="INSERT INTO ".$dom." (oid,pealkiri,url) VALUES (\"".$oid."\",\"".$_POST["pealkiri"]."\",\"".$_POST["url"]."\")";
...
<tr background="image/sinine.gif"> 
    ...
    <td colspan="1" class="options" ><input name="pealkiri" class="options" type="text" size="100">
...
<tr background="image/sinine.gif"> 
    ...
    <td colspan="1" class="options" >aadress</td>

    <td colspan="1" class="options" > <input name="url" class="options" type="text" size="100">
