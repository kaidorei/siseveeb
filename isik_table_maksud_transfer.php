...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		while($line=mysql_fetch_array($result)){
			?>
	        <tr background="image/sinine.gif"> 
          	<td colspan="18" background="image/sinine.gif"><img src="image/sinine.gif" width="1" height="1"></td>
	        </tr>
 	       <tr> 
           ...
           <td  width="4%" class="menu" nowrap><? if ($line["email1"]) { ?><a href="mailto:<? echo $line["email1"]; ?>"><img src="image/EmailIcon.jpg" alt="e-mail" width="18" height="20" border="0" /></a><? } ?></td>
           ...
           <td wvalign="middle"> <img width="50" border="0" src="<? echo urldecode($line["veeb_pilt_url"]); ?>" alt="x" name="veeb_pilt_url" align="right" style="background-color: #CCCCCC">    </td>
