<?  function tabel34($domain,$oid,$login,$sel,$lisa){
	switch ($sel)
	{
	case 1:	$query2="SELECT * FROM ".$domain." WHERE oid1=".$oid;
		break;
	case 2:	$query2="SELECT * FROM ".$domain." WHERE oid2=".$oid;
		break;
	}
...
//******************************************************************************
	...
	case "isik": $asi1="eesnimi,perenimi,email1";
		break;
	case "avaldus": $asi1="eesnimi,perenimi,email1";
		break;
	...
	case "isik": $asi2="eesnimi,perenimi,email1";
		break;
	case "avaldus": $asi2="eesnimi,perenimi,email1";
		break;
...
//		echo $dom1;
		switch ($dom1)
		{
			case "isik": $asi3=$t["eesnimi"]." ".$t["perenimi"]; $idee1="iid"; $email1=$t["email1"];
				break;
			case "avaldus": $asi3=$t["eesnimi"]." ".$t["perenimi"]; $idee1="iid"; $email1=$t["email1"];
				break;
			...
			case "kool": 
				...
				$asi3=$t["nimi"]."".$vah; $idee1="fid"; $email1=$t["email1"]; 
				break;
			...
			case "reis": 	$algus=$t{'algus'};
							...
							$idee1="reisid";
				break;
		case "vahendid": 	$algus=$tulem['date_algus'];
							$kuu=substr($algus,5,2);
							$paeva=substr($algus,8,2);
							$kuua = kuud($kuu, $keel);			
							$aastaa=substr($algus,0,4);
							...
							$asi3=$t["nimi"]."asd".$vah;//." ".$reisiaeg."asdf";
							$idee1="vid";
			break;
...
//		echo $asi3;
	...
	$count++;
				...
				<td><? if($dom2=="kool"&&$sel==1){?><span class="button4">  <a href="index.php?page=arve_disp&action=new&kool_id=<? echo $asi["oid"];?>&reis_id=<? echo $oid;?>">A</a>&nbsp;</span>
				  <? }else{?> <input type="button" class="button3" value="m" onClick="window.open('addvalue_iid_mod.php?domain=<? echo $asi["domain"];?>&id=<? echo $asi["id"]?>&sel=<? echo $asi["sel"]?>','Delete','toolbar=0,scrollbars=1,width=1020,height=850,status=yes');" ><? }?>				  </td>
			  ...
			  ?> <tr align="left" >
			      <td class="menu" ><input type="button" name="suva1" class="button" value="Lisa uus" onclick="window.open('addvalue_iid_tugikool.php?domain=<? echo $domain;?>&oid=<? echo $oid;?>','File_upload','toolbar=0,width=660,height=580,status=yes');" >
			        <?
