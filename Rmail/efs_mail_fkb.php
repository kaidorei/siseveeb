...
$count_mailer++;
echo "Count mailer after:",$count_mailer;
...
//		$mail->setBcc('barney@example.com');
	...
	?>
<form name="muugi" action="../Rmail/efs_mail.php?count_mailer=<? echo $count_mailer;?>&tootab=1&tid=<? echo $tid;?>">
  <table border="0" width="100%" style="padding: 0px; margin: 0px">
      <tr>
        <td colspan="4" class="pealkiri" ><div align="left"><? echo "Teate nimi:  ", $line_o["title"];
 ?>
        </div></td>
...
<? //echo "id=", $id;?>
        ...
        <td width="176" style="width: 7em; text-align: right"><input type="text" name="domain" class="fields" value="<? echo $domain;?>" size="6"></td>
        <td style="width: 7em; text-align: right"><input type="submit" class="button" value="start"></td>
      </tr>
     <tr>
        <td colspan="5" class="navi"><div align="left">	Email has been sent to <?=$address?>. Result: <? var_dump($result_mail)?><br><br>
</div></td>
        <td style="width: 7em; text-align: right">&nbsp;</td>
      </tr>
  </table>
