...
<tr> 
    <td background="image/sinine.gif" class="menu"><img src="image/spacer.gif" width="10" height="10">Arvamused, kommentaarid, arendus </td>
</tr>
<tr> 
    <td>
     	 <?
		...
		$tmp=array("date","body");
		log2("tootuba_alog",(isset($HTTP_GET_VARS["isik_alogopen"])?0:2),$tootid,$_SESSION["mysession"]["login"],implode(",",$tmp));
		?>
    </td>
</tr>
</table>
