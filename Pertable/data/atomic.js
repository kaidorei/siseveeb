...
{
numeric: false,
info: "electronconfinfo",
source: ("http://en.wikipedia.org/ wiki/ Electron_configurations_of_ the_elements_(data_page)").blank(),
category: "atomicprop"
}
);
...
RegisterData("electronegativity",
[
2.20,
null, 
0.98,
...
{
info: "elneginfo",
source: ("http://en.wikipedia.org/ wiki/ Electronegativities_of_ the_elements_(data_page)").blank(),
category: "atomicprop"
}
);
...
info: "oxidationinfo",
category: "atomicprop",
source: ("http://en.wikipedia.org/ wiki/ List_of_oxidation_ states_of_the_elements").blank(),
format: function(i) {
	if (this.data[i] == null)
